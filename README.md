...
Welcome to the PayTM Clone project! This is the basic version of PayTM and this project aims to replicate the basic functionality of PayTM, allowing users to perform transactions, view their account balance, and interact with other users.
...
1. **Clone the Repository**: Clone the repository from GitHub:
   ...
   ```
   git clone git@github.com:33Frok1e/PayTM.git
   ```
...
4. **Start the Backend Server**: In the `backend` folder, start the development server:

   ```
   node index.js // Whatever your root file name
   ```
